class MockData {
  ...
  class MockDB {
    ...
    /**
     * Asynchronously resets dataset to default values.
     */
    async reset() {
    ...
    /**
     * Checks to see if all keys on the given object match the keys expected in MockData.
     * @param {MockData} obj
     * @returns {boolean} boolean value, checks to see if input object's keys are valid keys.
     */
    isValidData(obj) {
